...
import FooterBlob from "./FooterBlob/FooterBlob";
...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    footerElement.querySelectorAll(".komplice1").forEach((el) => {
      timeline.fromTo(el, { y: "-50%" }, { y: "0%", duration: 1 }, 0);
    });

    footerElement.querySelectorAll(".komplice2").forEach((el) => {
      timeline.fromTo(el, { y: "-35%" }, { y: "0%", duration: 1 }, 0);
    });

    footerElement.querySelectorAll(".komplice3").forEach((el) => {
      timeline.fromTo(el, { y: "-20%" }, { y: "0%", duration: 1 }, 0);
    });

    footerElement.querySelectorAll(".komplice4").forEach((el) => {
      timeline.fromTo(el, { y: "-10%" }, { y: "0%", duration: 1 }, 0);
    });
